package com.dhj.demo.generator;
...
/**
 * mybatis-plus代码生成器
 * 参考 https://www.cnblogs.com/smfx1314/p/10849321.html
 */
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(projectPath + "/mybaties-plus-demo/src/main/java");
        //Author设置作者
        globalConfig.setAuthor("邓怀俊");
        //是否覆盖文件
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/mybaties-plus-demo/src/main/resources/mapper/"+ pc.getModuleName()
