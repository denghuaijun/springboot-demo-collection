package com.dhj.demo.websocket.intercepter;
 ...
 *
 */
public class CustomWebSocketInterceptor02 implements HandshakeInterceptor {
    private Logger logger = LoggerFactory.getLogger(CustomWebSocketInterceptor02.class);
    /**
